...
GNSS_config.ISBBDS_GPS = 69.13*c/1e9;%2018165 ClockBDS-ClockGPS
% Satellite to Omit
GNSS_config.omit = 40:151;%Control the GNSS type involved in the solution through this configuration
% GNSS type and PRN mapping list
GNSS_config.GPSPRNList=1:40;
GNSS_config.GLONASSPRNList=40:56;
...
TC_KF_config.gyro_noise_PSD = 3e-9;
...
old_time = 111184;
 ...
 L_ba_b=[0;0.3;0];
%  est_clock = [1788300.658, 321.943758];
...
FilePath.GNSSFile= 'GNSSTCdata0412v3.mat';
FilePath.INSFile= 'IMUData0412.mat';
