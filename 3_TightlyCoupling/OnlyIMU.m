function [r_eb_e,v_eb_e,C_b_e] = OnlyIMU(tor_i,old_r_eb_e,...
...
if mag_alpha>1.E-8
    ...
    %C_new_old = eye(3) + Alpha_ib_b + 0.5*Alpha_ib_b^2
end %if mag_alpha    

% Update attitude using (5.75)
% C_b_e = C_Earth * old_C_b_e * C_new_old;
    C_b_e = old_C_b_e * C_new_old;
...
% UPDATE VELOCITY
% From (5.36),
v_eb_e = old_v_eb_e + tor_i * (f_ib_e + [0;0;-9.7978]);
