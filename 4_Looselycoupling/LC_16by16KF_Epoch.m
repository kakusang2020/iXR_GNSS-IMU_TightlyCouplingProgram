function [est_C_b_e_new,est_v_eb_e_new,est_r_eb_e_new,est_IMU_bias_new,...
    P_matrix_new] = LC_16by16KF_Epoch(GNSS_r_eb_e,GNSS_v_eb_e,tor_s,...
    est_C_b_e_old,est_v_eb_e_old,est_r_eb_e_old,est_IMU_bias_old,...
    P_matrix_old,meas_f_ib_b,est_L_b_old,LC_KF_config,FIXFlag,CarSpeed)
...
delta_z(7,1) = norm(est_v_eb_e_old)/norm( eye(3) - Skew_symmetric(meas_f_ib_b)*est_C_b_e_old*[CarSpeed,0,0]);
